...
CA_SUBJECT="/C=US/ST=CA/O=Stoodly CA/CN=Stoodly CA"
SUBJECT="/C=US/ST=CA/O=Stoodly/CN=localhost"
ALT="DNS:localhost"
...
function gen_rsa_sha256() {
  ...
  openssl pkcs12 -export -password pass:stoodly \
...
function gen_ecdsa_nistp256_sha256() {
  ...
  openssl pkcs12 -export -password pass:stoodly -in ecdsa_nistp256_sha256_cert.pem \
...
function gen_ecdsa_nistp384_sha384() {
  ...
  openssl pkcs12 -export -password pass:stoodly -in ecdsa_nistp384_sha384_cert.pem \
